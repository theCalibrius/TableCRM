...
class ContactsRightPanelFields extends React.Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
    ...
    return (
      <div>
        {this.props.selectedContact ? (
          this.props.selectedContact.map(i => (
...
export default connect(mapStateToProps, null)(ContactsRightPanelFields);
